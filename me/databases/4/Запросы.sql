...
INSERT Сотрудник(Фамилия, Имя, Отчество, Номер_мобильного_телефона, Пол, Дата_рождения, Адрес_электронной_почты, Паспортные_данные, Заработная_плата, Статус)
...
INSERT Сотрудник(Фамилия, Имя, Отчество, Номер_мобильного_телефона, Пол, Дата_рождения, Адрес_электронной_почты, Паспортные_данные)
...
--/----------------------------------------------------------------------------
-- 5. Вывести всех сотрудников, которые находятся на больничном (для
--    директора).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 6. Вывести всех сотрудников, которые на данный момент работают (для
--    директора).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 9. Отправить сотрудника в отпуск (для директора).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 10. Отправить сотрудника на больничный (для директора).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 11. Список всех клиентов с краткой информацией для связи (для директора,
--     сотрудника).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 12. Вывести среднюю кадастровую стоимость всех земельных участков (для
...
--/----------------------------------------------------------------------------
-- 13. Вывести самое дорогое помещение в базе (для директора, клиента,
--     сотрудника).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 14. Вывести 5 самых дешевых доступных для покупки помещений (для директора,
--     клиента, сотрудника).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 15. Вывести список всех клиентов и количество помещений, которыми
...
--/----------------------------------------------------------------------------
-- 16. Вывести список всех клиентов, заключавших договора по купле продаже
...
--/----------------------------------------------------------------------------
-- 17. Вывести список помещений для которых в этом месяце кончается срок аренды
...
--/----------------------------------------------------------------------------
-- 18. Вывести список земельных участков, которые в данный момент арендованы
...
--/----------------------------------------------------------------------------
-- 19. Вывести список всех арендованных на данный момент помещений
--     (для директора, сотрудника).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 20. Вывести список всех арендованных на данный момент земельных участков
--     (для директора, сотрудника).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 21. Вывести список помещений, которые в данный момент арендованы
--    определенным клиентом (для директора, сотрудника).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 22. Вывести список всех клиентов и количество земельных участков, которыми
--    они владеют (для директора, сотрудника).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 23. Вывести список всех доступных для покупки помещений (для директора,
--     сотрудника, клиента).
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 24. Вывести список всех доступных для покупки земельных участков (для
...
--/----------------------------------------------------------------------------
-- 25. Вывести 5 самых дешевых доступных для покупки земельных участков (для

...
EXEC Изменить_статус_сотрудника 1, 'работает'
...
EXEC Сделать_недоступным_для_покупки 1, 'помещение'
...
EXEC Изменить_фамилию_сотрудника 1, 'Никитин'
...
--/----------------------------------------------------------------------------
-- 9. Вывести имя сотрудника, оформившего договор купли продажи помещения.
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 10. Вывести количество оформленых договоров купли-продажи помещений
...
--/----------------------------------------------------------------------------
-- 11. Получить среднюю зарплату сотрудника.
--/----------------------------------------------------------------------------
...
--/----------------------------------------------------------------------------
-- 12. Изменить зарплату сотрудника.
--/----------------------------------------------------------------------------
...
EXEC Изменить_зарплату_сотрудника 4, @Средняя_зарплата

--/----------------------------------------------------------------------------
-- 13. Посчитать выручку, которую агенство получило от сделок по купле-продаже
...
--/----------------------------------------------------------------------------
-- 14. Вывести количество земельных участков, которыми владеет клиент.
--/----------------------------------------------------------------------------

CREATE PROCEDURE Получить_количество_земельных_участков_клиента
	@ID int
AS
SELECT CONCAT(Фамилия, ' ', Имя, ' ', Отчество) AS Имя, SUM(Владелец) AS [Количество земельных участков]
FROM dbo.Клиент
...
--/----------------------------------------------------------------------------
-- 15. Вывести количество помещений, которыми владеет клиент.
--/----------------------------------------------------------------------------

CREATE PROCEDURE Получить_количество_помещений_клиента
	@ID int
AS
SELECT CONCAT(Фамилия, ' ', Имя, ' ', Отчество) AS Имя, SUM(Владелец) AS [Количество помещений]
FROM dbo.Клиент
